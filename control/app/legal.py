...
TERMS = f"""
**Plain-English summary, not a substitute for the terms below.** You put a small tool online with us and share it with people you choose. You keep everything you make. You pay $10 a month for each tool that is running, from a balance you top up yourself; nothing charges your card without your click, and your agent asks before anything costs money. Don't use us for anything illegal or harmful. We do our best to keep things running and backed up, but we are a small service and offer no guarantees. Either side can end this at any time; you can export everything first.
...
- **Prices.** $10 per running tool per month, counted by the day, with the first gigabyte of storage included and $0.25 per further gigabyte per month. A tool that is switched off costs nothing. Domain names cost what the registrar charges plus $2 a year. People you share with cost nothing. Current prices are always at `bh prices` and on the pricing page; we give at least 30 days' notice before raising them.
